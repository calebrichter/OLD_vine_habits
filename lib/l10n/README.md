...
regenerating the AppLocalizations delegate.
...
### Generating AppLocalizations in the command line
...
flutter gen-l10n \
    ...
    --output-localization-file=gallery_localizations_en.dart \
