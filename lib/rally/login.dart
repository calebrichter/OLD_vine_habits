...
import 'package:vine_habits/layout/image_placeholder.dart';
import 'package:vine_habits/layout/text_scale.dart';
import 'package:vine_habits/rally/app.dart';
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            labelText: AppLocalizations.of(context)!.rallyLoginUsername,
          ),
        ),
      ),
    );
    ...
    return Align(
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            labelText: AppLocalizations.of(context)!.rallyLoginPassword,
          ),
          obscureText: true,
        ),
      ),
...
class _ThumbButtonState extends State<_ThumbButton> {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      button: true,
      enabled: true,
      label: AppLocalizations.of(context)!.rallyLoginLabelLogin,
      child: MouseRegion(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Text(AppLocalizations.of(context)!.rallyLoginRememberMe),
            const Expanded(child: SizedBox.shrink()),
            _FilledButton(
              text: AppLocalizations.of(context)!.rallyLoginButtonLogin,
              onTap: onTap,
            ),
          ],
        ),
